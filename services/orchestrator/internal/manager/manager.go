...
func (m *Manager) Start(ctx context.Context) error {
	...
	if m.config.DatabaseURL != "" {
		...
		if err := validateRestrictedCredentialURL("WORKER_DATABASE_URL", m.config.WorkerDatabaseURL, "postgresql", "blwhatsappcopy_worker"); err != nil {
			return err
		}
...
func (m *Manager) spawnWorkerArtifactWithLaunch(
	...
	if m.registry != nil {
		...
		if requiredDatabaseRole == "" {
			...
			requiredDatabaseRole = "blwhatsappcopy_worker"
		}
