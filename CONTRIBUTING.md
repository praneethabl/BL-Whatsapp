# Contributing to BL WhatsApp Copy

Thanks for helping improve BL WhatsApp Copy. This project is an open-source beta, so focused bug fixes, documentation improvements, tests, and small, reviewable features are especially welcome.
...
- Search existing [issues](https://github.com/ygncode/blwhatsappcopy/issues) before opening a duplicate.
