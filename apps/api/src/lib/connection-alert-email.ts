  ...
  const content: BrandedEmailContent = {
    ...
    paragraphs: loggedOut
      ? [
          ...
          "Open the connection in BL WhatsApp Copy to start pairing. On your phone, open WhatsApp → Linked devices → Link a device, then scan the new QR code.",
        ]
      : [
          ...
          "Open BL WhatsApp Copy to check its current status and reconnect if needed.",
        ],
    details: [
