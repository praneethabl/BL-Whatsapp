...
export async function sendVerificationEmail(
  ...
  const content: BrandedEmailContent = {
    preheader: invitationToken
      ...
      : "Confirm your email address to finish setting up BL WhatsApp Copy.",
    eyebrow: "Account security",
    title: "Verify your email address",
    paragraphs: [
      invitationToken
        ? "Confirm your email address to finish creating your account and continue to the workspace invitation."
        : "Thanks for signing up. Confirm your email address to finish setting up your BL WhatsApp Copy account.",
    ],
...
export async function sendPasswordResetEmail(
  ...
  const content: BrandedEmailContent = {
    preheader: "Use this secure link to choose a new BL WhatsApp Copy password.",
    eyebrow: "Account security",
    title: "Reset your password",
    paragraphs: [
      "We received a request to reset the password for your BL WhatsApp Copy account.",
...
export async function sendInvitationEmail(
  ...
  const content: BrandedEmailContent = {
    preheader: `${inviterEmail} invited you to join ${safeCompanyName} on BL WhatsApp Copy.`,
    eyebrow: "Team invitation",
    title: `Join ${safeCompanyName}`,
    paragraphs: [
      "You have been invited to collaborate with the team on BL WhatsApp Copy.",
