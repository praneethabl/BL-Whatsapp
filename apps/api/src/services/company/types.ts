...
export interface Invitation {
  ...
  email: string;
  role: "admin" | "member";
  permissions: Partial<import("@blwhatsappcopy/shared").MemberPermissions>;
  token: string;
  invited_by: string;
...
export interface InvitationPreview {
  ...
  role: "admin" | "member";
  permissions: Partial<import("@blwhatsappcopy/shared").MemberPermissions>;
  effectivePermissions: import("@blwhatsappcopy/shared").MemberPermissions;
  expiresAt: Date;
  createdAt: Date;
}
...
export interface CompanyWithRole extends Company {
  role: "owner" | "admin" | "member";
  permissions: import("@blwhatsappcopy/shared").MemberPermissions;
}
