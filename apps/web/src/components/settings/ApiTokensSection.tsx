          ...
          <SetupStep index={2}>
            <p>
              {t(
                ...
                "Leave Client ID and Client Secret empty if the app asks. Continue, sign in to BL WhatsApp Copy, choose the workspace, and approve.",
              )}
            </p>
          </SetupStep>
        </ol>
          ...
          <SetupStep index={2}>
            <p>
              {t(
                ...
                "Continue, sign in to BL WhatsApp Copy, choose the workspace, and approve.",
              )}
            </p>
          </SetupStep>
        </ol>
        ...
        <ol className="space-y-4">
          <SetupStep index={1}>
            ...
            <CopyBlock
              ...
              value={`claude mcp add --transport http blwhatsappcopy ${mcpUrl} --header "Authorization: Bearer ${secret}"`}
            />
            {tokenHint && (
          ...
          <SetupStep index={2}>
            <p>
              {t(
                ...
                "Start a new Claude Code session — the BL WhatsApp Copy tools are available right away.",
              )}
            </p>
          </SetupStep>
        </ol>
