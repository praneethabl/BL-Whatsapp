...
// Type alias for backward compatibility (deprecated - import from @blwhatsappcopy/shared instead)
/** @deprecated Use CompanyMemberRole from @blwhatsappcopy/shared instead */
 ...
 * in @blwhatsappcopy/shared) on read, matching the existing `permissions`
