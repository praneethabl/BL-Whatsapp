# BL WhatsApp Copy Technical Overview

BL WhatsApp Copy is a multi-tenant collaborative WhatsApp inbox. Teams can manage connections, conversations, contacts, assignments, notes, labels, catalogs, notifications, audit logs, and analytics.
