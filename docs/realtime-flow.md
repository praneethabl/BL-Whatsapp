...
BL WhatsApp Copy uses self-hosted Centrifugo for server-to-browser realtime events. Centrifugo uses the existing NATS server as its horizontal PUB/SUB broker.
