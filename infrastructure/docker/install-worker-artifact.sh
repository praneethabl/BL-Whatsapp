...
artifact_source=${WORKER_ARTIFACT_SOURCE:-/opt/blwhatsappcopy/worker/whatsapp-worker}
checksum_source=${WORKER_ARTIFACT_SHA256_FILE:-/opt/blwhatsappcopy/worker/whatsapp-worker.sha256}
artifact_root=${WORKER_ARTIFACT_ROOT:-/var/lib/blwhatsappcopy/worker-artifacts}
